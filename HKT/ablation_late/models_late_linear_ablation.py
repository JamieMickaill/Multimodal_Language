...
class HKT_regression_no_A(nn.Module):
    def __init__(self, text_model, visual_model, acoustic_model, args, dropout=0.1, fusion_dim=128):
        ...
        # Late fusion layer: Combine individual modality predictions
        self.late_fusion_layer = nn.Linear(2, 1)
    ...
    def forward(self, input_ids, visual, acoustic,hcf, attention_mask=None, token_type_ids=None):
        ...
        # print(text_pred, visual_pred, acoustic_pred, hcf_pred)
        concatenated_predictions = torch.cat((text_pred, visual_pred), dim=1)
...
class HKT_regression_no_V(nn.Module):
    ...
    def forward(self, input_ids, visual, acoustic,hcf, attention_mask=None, token_type_ids=None):
        ...
        # print(text_pred, visual_pred, acoustic_pred, hcf_pred)
        concatenated_predictions = torch.cat((text_pred, acoustic_pred), dim=1)
...
class HKT_no_V(nn.Module):
    ...
    def forward(self, input_ids, visual, acoustic,hcf, attention_mask=None, token_type_ids=None):
        ...
        # print(text_pred, visual_pred, acoustic_pred, hcf_pred)
        concatenated_predictions = torch.cat((text_pred, acoustic_pred, hcf_pred), dim=1)
...
class HKT_no_A(nn.Module):
    ...
    def forward(self, input_ids, visual, acoustic,hcf, attention_mask=None, token_type_ids=None):
        ...
        # print(text_pred, visual_pred, acoustic_pred, hcf_pred)
        concatenated_predictions = torch.cat((text_pred, visual_pred, hcf_pred), dim=1)
...
class HKT_no_T(nn.Module):
    ...
    def forward(self, input_ids, visual, acoustic,hcf, attention_mask=None, token_type_ids=None):
        ...
        # print(text_pred, visual_pred, acoustic_pred, hcf_pred)
        concatenated_predictions = torch.cat(( visual_pred, acoustic_pred, hcf_pred), dim=1)
