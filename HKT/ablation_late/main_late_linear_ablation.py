...
from models_late_linear_ablation import *
...
parser.add_argument("--learning_rate_p", type=float, default=0.003)
...
def prep_for_training(num_training_steps):
    ...
    if args.model == "language_only":
        ...
        if args.dataset=="humor":
            ...
            hcf_model.load_state_dict(torch.load("./model_weights/init/mosi/sarcasmHCFTransformer")) #not used
