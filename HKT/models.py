...
from transformers.models.albert.modeling_albert import AlbertEmbeddings, AlbertLayerGroup #update import -> original throws errors (not used anyway?)
...
class HKTMultiLayerCrossAttn(nn.Module):
    ...
    def forward(self, input_ids, visual, acoustic,hcf, attention_mask=None, token_type_ids=None):
        ...
        text_output = self.text_model(input_ids, attention_mask=attention_mask, token_type_ids=token_type_ids).last_hidden_state #Updated as original code returns strings instead of tensor
